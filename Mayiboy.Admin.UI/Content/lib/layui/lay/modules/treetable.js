...
layui.define('jquery', function(exports){
  ...
  var enterSkin = 'layui-tree-enter', TreeTable = function(options){
  ...
  //初始化
  TreeTable.prototype.init = function (elem) {
    var that = this;
  ...
  //树节点解析
  TreeTable.prototype.tree = function (elem, children) {
  ...
  //点击节点回调
  TreeTable.prototype.click = function (elem, item) {
    var that = this, options = that.options;
  ...
  //伸展节点
  TreeTable.prototype.spread = function (elem, item) {
    var that = this, options = that.options;
  ...
  //通用事件
  TreeTable.prototype.on = function (elem) {
    var that = this, options = that.options;
  ...
  //拖拽节点
  TreeTable.prototype.move = {};
  TreeTable.prototype.drag = function (elem, item) {
    var that = this, options = that.options;
  ...
  exports('treetable', function(options){
      var tree = new TreeTable(options = options || {});
