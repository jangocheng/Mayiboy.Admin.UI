...
(function ($) {
    ...
    function _4aa(_4ab) {
        ...
        var tb = _4ac.textbox;
        var _myattribute = opts.attribute === undefined ? "" : opts.attribute;
        tb.find(".textbox-text").remove();
        if (opts.multiline) {
            $("<textarea " + _myattribute + " class=\"textbox-text\" autocomplete=\"off\"></textarea>").prependTo(tb);
        } else {
...
(function ($) {
    ...
    function _600(_601) {
        ...
        function _606(_60b, _60c, _60d) {
            ...
            var t = $("<table class=\"datagrid-htable\" height='30' border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_60b);
