...
namespace Mayiboy.Logic.Impl
{
	public class DepartmentService : BaseService, IDepartmentService
	{
		...
		/// <param name="request"></param>
		/// <returns></returns>
		public QueryOrganizationResponse QueryOrganization(QueryOrganizationRequest request)
		{
			var response = new QueryOrganizationResponse();

			try
			{
				var list = _departmentRepository.UseStoredProcedure<DepartmentPo>("proc_SystemDepartmentById_select", new { Id = request.DepartmentId });
			...
			catch (Exception ex)
			{
				...
				LogManager.LogicLogger.ErrorFormat("查询组织架构出错");
			}
			return response;
		}
	}
